...
const CanvasWrapper = ({ children, dpr }) => (
  <Canvas
    dpr={dpr}
    frameloop="always"
...
const MergedPlanes = forwardRef(({ material, width, count, height, heightSegments }, ref) => {
...
export default function Beams({
  ...
  const beamCount = Math.max(8, Math.round(beamNumber * qualityPreset.beamScale));
  ...
  return (
    <CanvasWrapper dpr={qualityPreset.dpr}>
      <group rotation={[0, 0, THREE.MathUtils.degToRad(rotation)]}>
        <PlaneNoise
          ...
          width={beamWidth}
          height={beamHeight}
          heightSegments={qualityPreset.heightSegments}
        />
