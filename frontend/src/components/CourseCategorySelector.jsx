          ...
          {COURSE_TRACKS.map((track) => {
            ...
            return (
              <button
                ...
                className={`group relative min-w-[82%] snap-start overflow-hidden rounded-[24px] border bg-[#090A0B] text-left transition duration-300 focus:outline-none focus-visible:ring-2 focus-visible:ring-white sm:min-w-0 ${
                  selected
